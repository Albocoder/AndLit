#andlit.vision.serializers.py

from rest_framework import serializers
from .models import VisionImageUploadModel
...
#serializer for the VisionImageUploadModel model, users Base64ImageFieldSerializer
class VisionImageUploadModelSerializer(serializers.HyperlinkedModelSerializer):
	image = Base64ImageFieldSerializer(max_length=None, use_url=True,)

	class Meta:
		model = VisionImageUploadModel
		fields = ('pk', 'image')
